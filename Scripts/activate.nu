...
let virtual-env = "C:\Users\jsrou\.virtualenvs\storefront-reV4no9R"
let bin = "Scripts"
let path-sep = ";"
...
let virtual_prompt = (if ("(storefront) " != "") {
    "(storefront) "
} {
...
alias deactivate = source "C:\Users\jsrou\.virtualenvs\storefront-reV4no9R\Scripts\deactivate.nu"
